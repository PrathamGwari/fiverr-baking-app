...
// find user account
app.get('/api/account/find/:email', function (req, res) {
...
app.get('/api/account/findOne/:email', function (req, res) {
...
app.get('/api/account/update/:email/:amount', function (req, res) {
